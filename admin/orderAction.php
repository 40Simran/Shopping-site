...
echo "<tr><th>Order Id</th><th>Customer Name</th><th>Address</th><th>E-mail.</th><th>Product</th><th>Total Amount</th><th>Payment Mode</th><th>Order Status</th><th>Action</th></tr>";
while($c=mysqli_fetch_array($b))
{
echo "<tr><td>".$c[0]."</td><td>".$c[1]."</td><td>".$c[2]."</td><td>".$c[3]."</td><td>".$c[4]."</td><td>".$c[5]."</td><td>".$c[6]."</td>
<td><a href=sendStatus.php?orderid=$c[0]><img src='images/check.png' height='20px' width='20px'></a></td><td><a href=deleteorder.php?orderid=$c[0]><img src='images/delete.png' height='20px' width='20px'></a></td></tr>";
}
echo "</table>";
