...
$raw_results ="SELECT * FROM `categories` WHERE (`category` LIKE '%".$query."%') OR (`product` LIKE '%".$query."%') OR  (`description` LIKE '%".$query."%')";
$search=mysqli_query($con,$raw_results);
